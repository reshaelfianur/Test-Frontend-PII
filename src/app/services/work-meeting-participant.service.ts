...
export class WorkMeetingParticipantService {

  private key: string = 'work-meeting/work-meeting-participant';
  ...
  absence(params: string) {
    return this._commonService.taskPut(this.key, "absence-save", params);
  }
